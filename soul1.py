...
TOKEN = '7839526953:AAG9surlhguTRR6nG_Vc4hK6c0dLvye0eGQ'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002168051594
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/MODS_CRACKER/1954*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*How to DDos ==> https://t.me/MODS_CRACKER/2006*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*@tencenttfather*", parse_mode='Markdown')
    else:
